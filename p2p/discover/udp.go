...
func (req *ping) name() string { return "PING/v7" }
...
func (req *pong) name() string { return "PONG/v7" }
...
func (req *findnode) name() string { return "FINDNODE/v7" }
...
func (req *neighbors) name() string { return "NEIGHBORS/v7" }
