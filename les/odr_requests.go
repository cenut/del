...
var (
	...
	errProducersHashMismatch   = errors.New("producer hash mismatch")
	errVotersHashMismatch   = errors.New("voter hash mismatch")
...
func (r *BlockRequest) Validate(db ethdb.Database, msg *Msg) error {
	...
	if header.ProducerHash != types.CalcProducerHash(body.Producers) {
		return errProducersHashMismatch
	}
	if header.VoterHash != types.CalcVoterHash(body.Voters) {
		return errVotersHashMismatch
	}
