...
func (bc *HeaderChain)GetVotersState(header *types.Header) types.VotersMap {
	return nil
}
func (bc *HeaderChain)GetVoters(header *types.Header) types.Voters {
	return nil
}
...
func (hc *HeaderChain) GetGenesisBlock() *types.Block{
	return nil
}
