...
func (clique *Clique) CalProducersWithoutParent(chain consensus.ChainReader, header *types.Header) (producers types.Producers, err error) {
	return nil, nil
}
func (clique *Clique) CalProducers(chain consensus.ChainReader, header *types.Header) (producers types.Producers, err error) {
	return nil, nil
}
...
func (c *Clique) VerifyDifficulty(chain consensus.ChainReader, block *types.Block) error {
	return nil
}
func (c *Clique) VerifyVoters(chain consensus.ChainReader, block *types.Block) error {
	return nil
}
func (c *Clique) VerifyProducers(chain consensus.ChainReader, block *types.Block) error {
	return nil
}
...
func (c *Clique) Prepare(chain consensus.ChainReader, header *types.Header, txs types.Transactions) error {
...
func (c *Clique) Finalize(chain consensus.ChainReader, header *types.Header, state *state.StateDB, txs []*types.Transaction, uncles []*types.Header, receipts []*types.Receipt, producers types.Producers, voters types.Voters) (*types.Block, error) {
	header.Root = state.IntermediateRoot(chain.Config().IsEIP158(header.Number))
	header.UncleHash = types.CalcUncleHash(nil)
	return types.NewBlock(header, txs, nil, receipts, producers, voters), nil
}
...
func (c *Clique) CalcDifficulty(chain consensus.ChainReader, header *types.Header, txs types.Transactions) *big.Int {
